...
export function QuickSubmitForm({ onSuccess, onCancel }: QuickSubmitFormProps) {
  ...
  return (
    <Card className="!gap-4 !p-3 sm:!p-4 md:!p-5">
      <div className="min-w-0">
        <h2 className="text-base font-semibold text-gray-900 sm:text-lg">
          Submit a product
        </h2>
        <p className="mt-0.5 text-sm text-gray-500">
          Title, description, prices, stock, and optional images.
        </p>
      </div>
